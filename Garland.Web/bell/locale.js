gt.locale = {
    ...
    chs: {
        ...
        // weather data
        "Clear Skies":"碧空","Fair Skies":"晴朗","Clouds":"阴云","Fog":"薄雾","Wind":"微风","Gales":"强风","Rain":"小雨","Showers":"暴雨","Thunder":"打雷","Thunderstorms":"雷雨","Dust Storms":"扬沙","Sandstorms":"沙尘暴","Hot Spells":"炎热的天气","Heat Waves":"热浪","Snow":"小雪","Blizzards":"暴雪","Gloom":"妖雾","Auroras":"极光","Darkness":"黑暗","Tension":"绝命","Storm Clouds":"暴风雨","Umbral Wind":"暗风","Umbral Static":"暗雾",

        // other
        "Perception": "鉴别力", "Gathering": "获得力", "Gathering Rate": "获得率", "Gathering Fortune": "优质率", "Cooldown": "冷却", "hours": "小时", "maintenance": "维护",
        "Mining": "采矿工", "Botany": "园艺工", "Fishing": "捕鱼人", "Unspoiled": "未知的", "Ephemeral": "限时的", "Legendary": "传说的", "Lush Vegetation": "草场", "Mineral Deposit": "矿脉", "Maple Tree": "良材", "Rocky Outcropping":"石场",
        "Collectable": "收集品", "Reducible": "精选", "Blue Scrips": "大地蓝票", "Red Scrips": "大地红票","White Scrips": "大地白票", "Yellow Scrips": "大地黄票",
        "Gold Saucer": "金碟游乐场", "Gold S.": "金碟", "The Hunt": "狩猎怪物",
        "Timeline": "采集时间轴", "Filters": "过滤", "Tasks": "只显示", "Other": "其他",
        "Classes": "显示职业", "Types": "显示类别",
        "Aetherial Reduction possible":"精选",
        "timers": "个采集时间", 'hidden': '个隐藏', "Search": "搜索", "Maps": "地图",
        "Select a list for this timer": "将闹钟列表导入数据库", "Create new list":"新建一个列表", "Name the new list":"起个名字吧",
