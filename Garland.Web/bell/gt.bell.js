    ...
    isFiltered: function(def, filters) {
        ...
        if (def.func == 'node') {
            ...
            if (filters.purplescripsOnly && !_.any(def.items, function(i) { return i.scrip == "Purple Gatherers' Scrip"; }))
                return true;
            if (filters.orangescripsOnly && !_.any(def.items, function(i) { return i.scrip == "Orange Gatherers' Scrip"; }))
                return true;
            ...
            if (filters.purplescripsOnly && def.scrip != "Purple Gatherers' Scrip")
                return true;
            if (filters.orangescripsOnly && def.scrip != "Orange Gatherers' Scrip")
                return true;
...
gt.scrips = { "Red Gatherers' Scrip": 65029, "Yellow Gatherers' Scrip": 65043, "White Gatherers' Scrip": 65069, "Purple Gatherers' Scrip": 65087 , "Orange Gatherers' Scrip": 65109};
gt.location = { };
